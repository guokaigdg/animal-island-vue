...
import { BackTop, Card } from '@';
import type { CardPattern } from '@/components/Card/types';
import { sectionStyle, sectionTitleStyle, tagStyle, labelStyle, demoBodyStyle, CodeBlock, ApiTable } from '../tools';
...
const VILLAGERS = [
    ...
    { name: '小花', romanized: 'Xiaohua', species: '长颈鹿', hobby: '摄影', desc: '个子最高的长颈鹿，拍日出最美的角度' },
...
// 容器内滚动
<BackTop :target="() => ref" :visibilityHeight="200" />`;
</script>
...
<template>
    <div :style="sectionStyle">
        ...
        <BackTop :target="getTarget" :visibility-height="400" />
